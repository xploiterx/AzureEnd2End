...
Los datos de la ciudad de Nueva York utilizados en este laboratorio se obtuvieron del sitio web de datos abiertos de la ciudad de Nueva York: https://opendata.cityofnewyork.us/. Se utilizaron los siguientes conjuntos de datos
    ...
    <br> Para lograr compartir este taller a las masas y brindar una experiencia real pero rentable en terminos de costo que permita el acceso a este tipo de recursos y conocimientos Azure trabajaremos con el 0.01% del tamaño de la datos para reducir considerablemnte los costos de este tipo deservicios ya que de lo contrario este taller tendría un costo mucho más elevado.</br>
